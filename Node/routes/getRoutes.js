...
get_route.get('/getalldatabyid/:id', product_controller.getallproductdetailbyuserid);
...
get_route.post('/post-data', upload.single('images'), auth, product_controller.insertproduct);
...
get_route.post('/generateotp', user_controller.generateotp);
get_route.post('/resetbyotp/:token', auth, user_controller.resetpasswordbyotp);
